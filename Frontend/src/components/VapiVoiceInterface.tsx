...
export const VapiVoiceInterface = () => {
    ...
    const toggleMute = () => {
        setIsMuted(!isMuted);
        // Note: Vapi SDK doesn't have a built-in mute function yet
        // This is a UI state for future implementation
        toast({
                                ...
                                <div className="flex gap-6 items-center">
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        <Button
                                            ...
                                            onClick={toggleMute}
                                            variant="outline"
                                            className={`h-16 w-16 rounded-full transition-all shadow-md ${isMuted
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        <div className="relative">
                                            ...
                                            <Button
                                                ...
                                                className="h-16 w-16 rounded-full transition-all relative z-10 bg-destructive hover:bg-destructive/90 shadow-lg shadow-destructive/50"
                                            >
