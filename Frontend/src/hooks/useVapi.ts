...
export const useVapi = () => {
    ...
    const startCall = useCallback(async (employeeName?: string, managerName?: string) => {
        try {
            ...
            console.log('✅ Call started with personalized greeting');
        } catch (err: any) {
            ...
            if (err.type === 'start-method-error') {
                errorMessage = 'Unable to connect to voice assistant. Please check your API credentials.';
            } else if (err.message) {
